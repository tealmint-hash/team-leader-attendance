...
if(attendees.length!==124)throw new Error(`Expected 124 attendees, found ${attendees.length}`);
if(attendees.some((person)=>person.region==="강원"))throw new Error("Removed region still present");
